...
# Whether to use Python's internal crypto algorithms or rely on OpenSSL's
# implementation
%global internal_crypto 1
...
%if 0%{?fedora} < 18 || 0%{?amzn1}
# Version is only required if python-2.6.4-setup-db48.patch is applied
...
Patch1002: Python-2.7.5-disable-test_missing_localfile.patch
...
%changelog
* Tue Sep 3 2013 Heath Petty <hpetty@amazon.com>
- Cleaned up test case patch and renamed patch file

* Fri Aug 30 2013 Heath Petty <hpetty@amazon.com>
- Small changes to spec file and urllib patch
- Disabled debug subpackage build, changed test case patch

* Thu Aug 29 2013 Heath Petty <hpetty@amazon.com>
- Added patch to remove the test_missing_localfile unit test

* Mon Aug 26 2013 Heath Petty <hpetty@amazon.com>
- import source package F19/python-2.7.5-4.fc19
- Added upstream patches and fixed up spec file.

* Thu Aug 22 2013 Heath Petty <hpetty@amazon.com>
- import source package F18/python-2.7.5-3.fc19
- import source package F18/python-2.7.5-1.fc19

* Mon Aug 19 2013 Matej Stuchlik <mstuchli@redhat.com> - 2.7.5-4
...
* Mon May 6 2013 Lee Trager <ltrager@amazon.com>
- import source package F18/python-2.7.3-13.fc18
